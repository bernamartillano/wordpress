                    ...
                    <footer id="site-footer" role="contentinfo" style = "padding-bottom: 0;">
                    	 ...
                    	 <?php if ( is_active_sidebar( 'footer-widget-area' ) ) : ?>
							...
							<div class="site-footer-widget-area" style="margin-top: 0; height: 100%;">
                        ...
                        <div class="site-footer-copyright-area" style="background-color: #3f3777;color: #fff;">
                            <div class="row">
								<div class="large-12 columns">
									<br><br>
