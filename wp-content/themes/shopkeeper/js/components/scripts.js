jQuery(document).ready(function ($) {
	...
	if ( getbowtied_scripts_vars.product_lightbox != 1 && getbowtied_scripts_vars.product_gallery_zoom != 1 ) {
		$('.product_layout_classic .product-images-wrapper .product_images .swiper-slide a').css({'cursor' :'default'});
	}
...
jQuery(function($) {
	...
	$(document).on('click', 'header .site-tools .search-button .spk-icon-search', function(){
		setTimeout( function(){
